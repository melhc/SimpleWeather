...
public class Utility {
	 ...
	 * 处理服务端返回的省级json数据
	 */
	public synchronized boolean handleProvicesResponse(WeatherDB weatherDB,
			String response) {
	 ...
	 * 处理服务端返回的市级json数据
	 */
	public synchronized boolean handleCitiesResponse(WeatherDB weatherDB,
	 ...
	 * 处理服务端返回的县级json数据
	 */
	public synchronized boolean handleCountiesResponse(WeatherDB weatherDB,
